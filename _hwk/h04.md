...
<ol>
<li style="margin-bottom: 6em;" markdown="1"> (10 pts) What does it mean to <em>next</em> control structures in Python?
...
<li style="margin-bottom: 0.5em;" markdown="1"> (20 pts) Read about the `if` and `else` statements in Section 3.2, including what happens when the various programs in Section 3.2 are run.
