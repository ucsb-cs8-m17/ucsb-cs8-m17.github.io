...
<li markdown="1" > The first two questions are essay/short answer type of question, with
...
<ol>
<li style="margin-bottom:10em;">(10 pts) What is a "Design Pattern"?
</li>

<li style="margin-bottom:10em;">(10 pts) What is one of the benefits of having 
...
<li class="page-break-before" markdown="1" style="margin-bottom:1em;">  (10 pts) (CONTINUED FROM PREVIOUS PROBLEM).   A third option for the event handler for a button is to use
