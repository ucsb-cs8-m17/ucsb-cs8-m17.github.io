...
Three practice exams are available.  Each comes with a handout. 

*    [The actual M16 E01 midterm](cs56_m16_e01){:data-ajax="false"}, 
     and [handout](cs56_m16_e01/handout){:data-ajax="false"}
   * Note: the material about "tokens" and "parsing" on this exam will not be our first midterm&mdash;we haven't yet covered that material.
