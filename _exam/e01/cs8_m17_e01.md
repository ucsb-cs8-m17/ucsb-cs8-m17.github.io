...
|---------|-------------|--------|-|--------|-------------|--------|
| (2 pts) | `team[0:2]`        |  | | (2 pts) | `team > sport` | |
| (2 pts) | `sport[1:3]`          |  | |(2 pts) | `len(season)`   | |
| (2 pts) | `season[-1]`        |  | |(2 pts) | `type(season)`   | |
...
<li style="margin-bottom:3.0in;" markdown="1"> (8 pts)  As you may recall from your math courses, 2&pi; radians = 360&deg;, therefore
...
<li markdown="1" style="margin-bottom: 8em;"> (8 pts) Why do we need the `pytest.approx` thing?   That is, why can't we just write: `assert cToF(100.0)==212.0`?

</li>

<li markdown="1" style="margin-bottom: 2.5in;"> (9 pts) Now consider the `deg2rad` function you write earlier.   Please write
...
<li markdown="1" style="margin-bottom:4in;">(3 pts) How can you tell if a path to a file or directory is a <em>relative path</em> or an <em>absolute path?</em>
</li>
